...
{	
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{		 
			try
			{
				String updateTemp ="INSERT INTO tracks VALUES("+
				IDTF.getText() +",'"+ArtistNameTF.getText()+"','"+TrackNameTF.getText()+"',"+AlbumNameTF.getText()+",'"+MilsecPlayedTF.getText()+"','"
				+DanceabilityTF.getText()+"','"+EnergyTF.getText()+"',"+LoudnessTF.getText()+","+SpeechinessTF.getText()+","+AcousticnessTF.getText()+","
				+InstrumentalnessTF.getText()+","+LivenessTF.getText()+","+ValenceTF.getText()+","+TempoTF.getText()+","+MilsecDurationTF.getText()+");";
		...
		{	 	
			try
			{ 			
				String updateTemp ="UPDATE tracks SET " +
				"artistName = '"+ArtistNameTF.getText()+
				"', trackName = '"+TrackNameTF.getText()+
				"', albumName = "+AlbumNameTF.getText()+
				", milsecPlayed ='"+MilsecPlayedTF.getText()+
				"', danceability = '"+DanceabilityTF.getText()+
				"', energy = '"+EnergyTF.getText()+
				"', loudness = "+LoudnessTF.getText()+
				", speechiness = "+SpeechinessTF.getText()+
				", acousticness = "+AcousticnessTF.getText()+
				", instrumentalness = "+InstrumentalnessTF.getText()+
				", liveness = "+LivenessTF.getText()+
				", valence = "+ValenceTF.getText()+
				", tempo = "+TempoTF.getText()+
				", milsecDuration = "+MilsecDurationTF.getText()+
